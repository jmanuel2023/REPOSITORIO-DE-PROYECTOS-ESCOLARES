...
public class ServicioTres {
    private static final String SERVICIOTRES_ENDPOINT = "/servidor3";
    private static final String ENDPOINT_GRAFICAS = "/datosServidor3";
    ...
    public static void main (String [] args){
        ...
        ServicioTres serTres = new ServicioTres(serverPort);
        serTres.startServer();
        System.out.println("Servidor en el puerto: "+serverPort);
    }
    public ServicioTres(int port){
        this.port = port;
    }    
    public void startServer() {
        ...
        HttpContext serviciotresContext = server.createContext(SERVICIOTRES_ENDPOINT);
        HttpContext graficaContext = server.createContext(ENDPOINT_GRAFICAS);
        serviciotresContext.setHandler(this::handleServicioTresRequest);
    ...
    private void handleServicioTresRequest (HttpExchange exchange) throws IOException {
