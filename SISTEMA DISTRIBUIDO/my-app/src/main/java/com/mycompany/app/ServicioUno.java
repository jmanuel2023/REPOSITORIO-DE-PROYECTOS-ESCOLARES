...
public class ServicioUno {
    ...
    private static final String SERVICIOUNO_ENDPOINT = "/servidor1";
    private static final String ENDPOINT_GRAFICAS = "/datosServidor1";
    private int port;
    ...
    public static void main (String [] args){
        ...
        ServicioUno serUno = new ServicioUno(serverPort);
        serUno.startServer();
        System.out.println("Servidor en el puerto: "+serverPort);
    }
    public ServicioUno(int port){
        this.port = port;
    }    
    public void startServer() {
        ...
        HttpContext serviciounoContext = server.createContext(SERVICIOUNO_ENDPOINT);
        HttpContext graficaContext = server.createContext(ENDPOINT_GRAFICAS);
        serviciounoContext.setHandler(this::handleServicioUnoRequest);
    ...
    private void handleServicioUnoRequest (HttpExchange exchange) throws IOException {
