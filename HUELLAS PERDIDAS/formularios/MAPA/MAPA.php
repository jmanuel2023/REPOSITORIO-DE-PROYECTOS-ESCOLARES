  ...
  <main>
    <nav class="navbar navbar-dark bg-black" aria-label="First navbar example">
      <div class="container-fluid">
        ...
        <h1 style="color:blanchedalmond;font-size:20px; text-align:center;"><p>Hola Alumn@: <?php echo $nombre?></p></h1>
          ...
          <ul class="navbar-nav me-auto mb-2">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="descargarpdfAni.php" target="_blank">DESCARGAR PDF</a></li>
                <li><a class="dropdown-item" href="buscaAni.html">BUSCAR ANIMALES</a></li>
                <li><a class="dropdown-item" href="juegos.html" target="_blank">DESCARGAR JUEGOS DIDACTICOS</a></li>
              </ul>
      ...
      <script src="mapamundial.js"></script>
...
<!--<a href="" class="btn btn-1">ENVIAR POR CORREO PDF DE TODOS LOS ANIMALES</a><br>
    <a href="" class="btn btn-1">BUSCAR ANIMALES</a><br>-->
</div>
</main>
